...
public class NeoTailwind : Card, IRegisterable, IHasCustomCardTraits
{
    public static Spr TempPlaceHolderArt;
    
    private static string _cardName = "Tailwind";
    private int _cardcostNone = 1;
    private int _cardcostA = 1;
    private int _cardcostB = 0;
    private string _actionOneNone = "action.drawCard";
    private string _actionOneA = "action.drawCard";
    private string _actionOneB = "action.drawCard";
    private int _actionOneAmountNone = 4;
    private int _actionOneAmountA = 6;
    private int _actionOneAmountB = 3;
    ...
    private Spr? _artNone = StableSpr.cards_Ace;
    private Spr? _artA = StableSpr.cards_Ace;
    private Spr? _artB = StableSpr.cards_Ace;
        ...
        else if (_artmode == 3)
        {
            return upgrade switch
            {
                ...
                [
                    ...
                    {
                        _drawNumber = _actionOneAmountNone
                    }
                ],
                Upgrade.A =>
                [
    ...
    {
        _descriptionNone =
            $"On draw, <c=downside>-1 energy</c> but draw {_actionOneAmountNone}.";
        _descriptionA =
            $"On draw, <c=downside>-1 energy</c> but draw {_actionOneAmountA}.";
        _descriptionB =
            $"On draw, draw {_actionOneAmountB}.";
        if (_artmode == 0)
        {
            if (upgrade == Upgrade.None)
            {
