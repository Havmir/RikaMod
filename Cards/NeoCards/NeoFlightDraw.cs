...
public class NeoFlightDraw: Card, IRegisterable, IHasCustomCardTraits
{
    public static Spr TempPlaceHolderArt;
    
    private static string _cardName = "RikaFlightDraw";
    // Make sure to update rarirty
    private int _cardcostNone = 1;
    private int _cardcostA = 0;
    private int _cardcostB = 1;
    private string _actionOneNone = "flightDrawStatusName";
    private string _actionOneA = "flightDrawStatusName";
    private string _actionOneB = "flightDrawStatusName";
    ...
    private Spr? _artNone = StableSpr.cards_Options;
    private Spr? _artA =  StableSpr.cards_Options;
    private Spr? _artB =  StableSpr.cards_Options;
    ...
    {
        _descriptionNone =
            $"On draw, <c=downside>-{_cardcostNone} energy</c>, but gain {_actionOneAmountNone}      <c=status>flight draw</c>.";
        _descriptionA =
            $"On draw, gain {_actionOneAmountA}     <c=status>flight draw</c>.";
        _descriptionB =
            $"On draw, <c=downside>-{_cardcostB} energy</c>, but gain {_actionOneAmountB}      <c=status>flight draw</c>.";
        if (_artmode == 0)
        {
            if (upgrade == Upgrade.None)
            {
