...
public class NeoBarrelRoll : Card, IRegisterable, IHasCustomCardTraits
{
    public static Spr TempPlaceHolderArt;
    
    private static string _cardName = "BarrelRoll";
    private int _cardcostNone = 0;
    private int _cardcostA = 0;
    private int _cardcostB = 0;
    private string _actionOneNone = "status.autopilot";
    private string _actionOneA = "status.autopilot";
    private string _actionOneB = "status.autopilot";
    private string _actionTwoB = "action.moveRandom";
    private int _actionOneAmountNone = 1;
    private int _actionOneAmountA = 2;
    ...
    private Spr? _artNone = StableSpr.cards_Reroute;
    private Spr? _artA =  StableSpr.cards_Reroute;
    private Spr? _artB =  StableSpr.cards_Reroute;
    ...
    {
        _descriptionNone =
            $"On draw, gain {_actionOneAmountNone} <c=status>autopilot</c>.";
        _descriptionA =
            $"On draw, gain {_actionOneAmountA} <c=status>autopilot</c>.";
        _descriptionB =
            $"On draw, gain {_actionOneAmountB} <c=status>autopilot</c> & randomally move {_actionTwoAmountB} spaces.";
        if (_artmode == 0)
        {
            if (upgrade == Upgrade.None)
            {
