...
public class NeoPowerBoost : Card, IRegisterable, IHasCustomCardTraits
{
    public static Spr TempPlaceHolderArt;
    
    private static string _cardName = "PowerBoost";
    // Make sure to update rarirty
    private int _cardcostNone = 1;
    private int _cardcostA = 0;
    private int _cardcostB = 1;
    private string _actionOneNone = "status.overdrive";
    private string _actionOneA = "status.overdrive";
    private string _actionOneB = "status.overdrive";
    ...
    private Spr? _artNone = StableSpr.cards_Overpower;
    private Spr? _artA =  StableSpr.cards_Overpower;
    private Spr? _artB =  StableSpr.cards_Overpower;
