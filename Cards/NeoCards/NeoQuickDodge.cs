...
public class NeoQuickDodge : Card, IRegisterable, IHasCustomCardTraits
{
    public static Spr TempPlaceHolderArt;
    
    private static string _cardName = "QuickDodge";
    // Make sure to update rarirty
    private int _cardcostNone = 1;
    private int _cardcostA = 1;
    private int _cardcostB = 1;
    private string _actionTwoNone = "status.evade";
    private string _actionTwoA = "status.evade";
    private string _actionTwoB = "status.evade";
    private int _actionTwoAmountNone = 2;
    private int _actionTwoAmountA = 2;
    private int _actionTwoAmountB = 3;
    ...
    private bool _isRetainNone = true;
    private bool _isRetainA = false;
    private bool _isRetainB = true;
    ...
    {
        _descriptionNone =
            $"On draw, <c=downside>-{_cardcostNone} energy</c> but gain {_actionTwoAmountNone} <c=status>evade</c>.";
        _descriptionA =
            $"On draw, <c=downside>-{_cardcostA} energy</c> but gain {_actionTwoAmountA} <c=status>evade</c>.";
        _descriptionB =
            $"On draw, <c=downside>-{_cardcostB} energy</c> but gain {_actionTwoAmountB} <c=status>evade</c>.";
        if (_artmode == 0)
        {
            if (upgrade == Upgrade.None)
            {
